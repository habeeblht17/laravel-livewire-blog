...
<article class="col-span-4 md:col-span-3 mt-10 mx-auto py-5 w-full" style="max-width:700px">
    <img class="w-full my-2 rounded-lg" src="{{ $post->getThumbnailUrl() }}" style="height: 350px;" alt="">
    ...
    <div
        ...
        <div class="flex items-center">
            <livewire:partials.like-button :key="'post-like'. $post->id" :$post />
        </div>
        <div>
            <div class="flex items-center">
                <button>
    ...
    <livewire:comments.postcomment :key="'post-comment'. $post->id" :$post />
</article>
